<template >
	<form>
		<div class="flex-col space-y-4 p-6 md:w-64 lg:w-96 border shadow-lg rounded ">
			...
			<div class="mb-6">
				<label for="password"
					class="block mb-2 text-sm font-medium text-zinc-800 dark:text-zinc-800">Password</label>
			...
			<div class="flex items-start mb-6">
				<div class="flex items-center h-5">
					<input id="remember" type="checkbox" value=""
						class="w-4 h-4 border  rounded    border-zinc-800 focus:ring-zinc-800 dark:ring-offset-gray-800"
						required>
					<label for="remember" class="ml-2 text-sm font-medium text-zinc-800">Remember
						Me</label>
				</div>

			</div>
			<button type="submit" class="font-semibold bg-zinc-800 rounded px-3.5 py-1.5 hover:scale-110 w-full">Sign
				In</button>
		</div>
