	...
	<form>
		<div class="flex-col space-y-4 p-6 md:w-64 lg:w-96 ">
			...
			<label for="remember" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a
					href="#" class="text-white font-semibold hover:underline ">terms and conditions</a>.</label>
		</div>
		<button type="submit"
			class="font-semibold bg-sky-900 rounded px-3.5 py-1.5 hover:scale-110 w-full">Register</button>
	</div>
